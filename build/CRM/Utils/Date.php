      ...
      case 'month':
        switch ($relativeTerm) {
          ...
          case 'before_last_6':
            ...
            $to['M'] = $now['mon'];
            $to['Y'] = $now['year'];
            $to = self::intervalAdd('month', -6, $to);
            unset($from);
            break;
          ...
          case 'before_last_12':
            ...
            $to['M'] = $now['mon'];
            $to['Y'] = $now['year'];
            $to = self::intervalAdd('month', -12, $to);
            unset($from);
            break;
